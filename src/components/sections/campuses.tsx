...
import { Building2, ArrowUpRight, Globe, Layers, ShieldCheck } from 'lucide-react';
  ...
  return (
    <section className="bg-background py-16 md:py-32 relative overflow-hidden border-t border-white/5">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        {/* Horizontal auto-scrolling campuses carousel — user can scroll/drag too */}
        <div className="relative">
          ...
          <ScrollableMarquee speed={160} className="py-2" innerClassName="flex gap-8 md:gap-10">
            {hubs.map((hub, index) => (
              <motion.div
                  ...
                  <div className="mt-auto space-y-5">
                    ...
                    <button
                      ...
                      className={`group/btn w-full py-4 text-[10px] font-black uppercase tracking-[0.4em] rounded-2xl transition-all duration-300 transform active:scale-95 shadow-2xl flex items-center justify-center gap-3 ${
                        hub.isComingSoon ? 'bg-white/5 text-muted-foreground border border-white/5 cursor-not-allowed opacity-40' : 'bg-primary text-primary-foreground hover:brightness-110 shadow-primary/10'
                      }`}
                    >
