...
Personal Information Provided by You. We collect phone numbers; names; email addresses; and other similar information.

Payment Data. We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by Razorpay. You may find their privacy notice link(s) here: https://policies.google.com/privacy.
...
All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.`,
  },
  {
    ...
    content: `In Short: We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.
...
We may process or share your data that we hold based on the following legal basis:`,
    list: [
      ...
      "Vital Interests: We may disclose your information where we believe it is necessary to investigate, prevent, or take action regarding potential violations of our policies, suspected fraud, or situations involving potential threats to the safety of any person.",
...
We have implemented appropriate technical and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security, and improperly collect, access, steal, or modify your information. Although we will do our best to protect your personal information, transmission of personal information to and from our Website is at your own risk. You should only access the Website within a secure environment.`,
  },
  {
    ...
    content: `In Short: In some regions, such as the European Economic Area (EEA) and United Kingdom (UK), you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.
...
Email: contact@madalgos.in`,
  },
  {
    ...
    content: `Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: https://madalgos.in/contact.`,
  },
];
    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground antialiased">
      ...
      <main className="pt-28 md:pt-32 pb-24">
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          {/* Intro */}
          <div className="mb-8 rounded-2xl border border-white/8 bg-card/40 px-6 py-6 text-sm text-muted-foreground leading-relaxed space-y-3">
            <p>
              Thank you for choosing to be part of our community at{" "}
              <span className="text-foreground font-medium">MAD Algos</span>{" "}
            ...
            <p>
              ...
              <a href="https://madalgos.in" className="text-primary hover:underline">
                https://madalgos.in
              </a>{" "}
              or engage with us in other related ways — including any sales, marketing,
              or events.
            </p>
            <p>
            ...
            {sections.map((s) => (
              ...
              >
                ...
                <div className="pl-10 space-y-3">
                  {s.content.split("\n\n").map((para, pi) => (
                    <p key={pi} className="text-sm leading-relaxed text-muted-foreground whitespace-pre-line">
                      {para.trim()}
                    </p>
                  ))}
